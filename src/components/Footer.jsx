  ...
  return (
    <footer className="border-t border-slate-100 bg-white">
      <div className="container-app flex flex-col gap-10 py-12 md:flex-row md:justify-between">
        ...
        {/* Nav links + social, stacked on mobile, side-by-side on desktop */}
            ...
            <div className="mt-3 flex items-center gap-3">
              {socialLinks.map(({ icon: Icon, href, label }) => (
                <a
                  ...
                  href={href}
                  aria-label={label}
                  className="flex h-9 w-9 items-center justify-center rounded-full bg-slate-100 text-slate-600 transition-colors hover:bg-brand-100 hover:text-brand-700"
                >
                  <Icon size={16} />
                </a>
              ))}
      ...
      <div className="border-t border-slate-100 py-5">
        <p className="container-app text-center text-xs text-slate-400 md:text-left">
